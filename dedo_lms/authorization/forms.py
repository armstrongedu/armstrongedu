...
class SignUpForm(auth_forms.UserCreationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].widget.attrs.update(
            {'class': 'input has-background-dark is-large', 'placeholder': 'Password',}
        )
        self.fields['password1'].help_text = password_validation.password_validators_help_texts()
        self.fields['password2'].widget.attrs.update(
            {'class': 'input has-background-dark is-large', 'placeholder': 'Confirm Password',}
        )
    ...
    class Meta:
        ...
        widgets = {
            'email': forms.EmailInput(attrs={'class': 'input has-background-dark is-large', 'placeholder': 'Email', 'autocomplete': 'email'}),
        }
...
class LoginForm(auth_forms.AuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update(
            {'class': 'input has-background-dark is-large', 'placeholder': 'Email', 'autocomplete': 'email'}
        )
