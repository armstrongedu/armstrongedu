...
def checkout(request):
    ...
    accept_api_request = {
        ...
        "billing_data": {
            "apartment": billing_data_form['address_1'],
            "email": request.user.email,
            "floor": "",
            "first_name": billing_data_form['first_name'],
            "street": "",
            "building": "",
            "phone_number": billing_data_form['phone'],
            "shipping_method": "",
            "postal_code": billing_data_form['postal_code'],
            "city": billing_data_form['city'],
            "country": billing_data_form['country'],
            "last_name": billing_data_form['last_name'],
            "state": billing_data_form['state'],
        },
        "currency": "EGP",
