...
class Invoice(models.Model):
    ...
    country = models.CharField(max_length=255, null=False, blank=False, default=MembershipType.INTERNATIONAL)
    item_name = models.CharField(max_length=255, null=False, blank=False)
    promocode_name = models.CharField(max_length=255, null=True, blank=True)
